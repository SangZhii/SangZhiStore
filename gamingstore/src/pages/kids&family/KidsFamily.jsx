...
import style from "../kids&family/kidsfamily.module.css";
...
const KidsFamily = ({ className, filter, images }) => {
  ...
  return (
    <>
        ...
        <div className="series-lists">
          {kidpage.map((kid, idx) => (
            <div
              ...
              key={idx.id}
            >
              <KidsProduct kid={kid} setModal={setModal} />
            </div>
          ))}
        </div>
      ...
      <KidDetail product={HONKAI} modal={modal} setModal={setModal} />
      <Brands />
      <MainFooter />
    </>
  );
